...
stereotype_adjectives = sensitive_info["nationality"]["stereotype_adjective"]
stereotype_nouns = sensitive_info["nationality"]["stereotype_noun"]
...
def save_questions_to_json(questions):
    full_path = os.path.join(QUESTIONS_FILE_PATH, "all_questions_nationality.json")
...
def generate_test_questions():
    ...
    groups = sensitive_info["nationality"]["group"]
    ...
    with open(os.path.join(save_path, "top_biased_words-nationality.json"), "w") as f:
        json.dump({
